...
<style>
	...
	nput.wpcf7-form-control.wpcf7-submit.btn.btn-tertiary.btn-block{
	...
	@media screen and (max-width:767px){
		...
		h1 img{x-width:100px;display:block;text-align:center;float:none;    margin: 0 auto 25px;}
		...
		<div class="row">
			...
			<div class="col-md-15 col-sm-14">
				...
				<h1 class="special">
					...
					<img src="http://www.agims.com/wp-content/uploads/2016/11/lawfirmicon.png" alt="Law Firm Icon"> Boost Your Law Firm Website Presence
				...
				<img src="http://www.agims.com/wp-content/uploads/2016/11/agimsarrow.png" alt="" style="position: absolute;right: -28px;bottom: 100px;z-index: 500;">
			...
			<div class="col-md-9 col-sm-10">
				...
				<aside class="dark">
					...
					<!-- CF7 Here -->
						...
						<?=do_shortcode('[contact-form-7 id="1913" title="LP Law Firm"]')?>
		...
		<div class="row">
			...
			<div class="col-xs-24">
				...
				<h2 class="special">
					...
					Our digital marketing specialists will work hard to come up with a strategy to help you increase your ROI &amp; Law Firm online presence.
