		...
		<div class="row">
			...
			<div class="col-md-15 col-sm-14">
				...
				<h1 class="special">
					...
					We know you hate filling out these forms, but here's what you're going to get
...
<img src="http://www.agims.com/wp-content/uploads/2016/11/agimsarrow.png" alt="" style="position: absolute;right: -28px;bottom: 0px;z-index: 500;">
			...
			<div class="col-md-9 col-sm-10">
				...
				<aside class="dark">
					...
					<!-- CF7 Here -->
						...
						<?=do_shortcode('[contact-form-7 id="152" title="Free Audit"]')?>
		...
		<div class="row">
			...
			<div class="col-xs-24">
				...
				<h2 class="special">
					...
					Our digital marketing specialists will work hard to come up with a strategy to help you increase your ROI &amp; online presence.
		...
		<div class="row">
			...
			<div class="col-md-15 col-sm-14">
				...
				<p>At AGI Marketing, we believe any successful campaign has to have a strong market strategy behind it. We will work with you one on one to develop a strategy that works for you and ensures your success.</p>

			</div>

			<div class="col-md-9 col-sm-10">

				<p>Our FREE digital marketing analysis will provide you with all of the information you need to make educated, informed business decisions.</p>
