            ...
            <div class="col-md-4 col-lg-4 col-xs-12">
                <div class="sidebar" id="sidebar">
                    <div id="contact-form"><h3>Contact Us</h3>
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/landing/logo-agi.png"
                             alt="AGI Marketing"/>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <ul class="check-list">
                        <li>Building a great website</li>
                        <li>Optimizing your site to be Google Friendly</li>
                        <li>Posts across multiple social media platforms</li>
                        <li>Facebook ads</li>
                        <li>Adwords advertising campaigns</li>
                        <li>Regular blog posts</li>
                        <li>Strong website content</li>
                    </ul>
                </div>
            </div>
        </div>
