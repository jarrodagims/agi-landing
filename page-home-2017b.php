...
get_header(home); ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div id="topnav" class="col-lg-19 col-md-17 col-sm-24">
                    ...
                    ?>
                    <a href="tel:915-209-5381" class="m-phone"
                       onclick="ga('send', 'event', [phonecalls], [mobileCTC], [header9152095381], [none], [fieldsObject]);"><i
                                aria-hidden="true">Call Now</i></a>
                </div>
            </div>
        </div>
    </div>
    <div id="home-header-cta">
        ...
        <div class="container">
            <div class="row">
                <div id="topsocial" class="col-lg-6 col-md-6 col-sm-12 col-xs-12 col-xxs-12 text-center"
                     style="text-align: left;">
                    <a href="https://www.facebook.com/agimarketing"
                       style="border-right: 1px solid #3b3b3b;display: inline-block;border-left: 1px solid #3b3b3b;width: 50px;text-align: center;margin-right: -4px;"><i
                                class="fa fa-facebook" aria-hidden="true"></i></a>
                    <a href="https://twitter.com/agi_marketing"
                       style="width: 50px;display: inline-block;border-right: 1px solid #3b3b3b;text-align: center;margin-right: -4px;"><i
                                class="fa fa-twitter" aria-hidden="true"
                                style="/* border-right: 1px solid #3b3b3b; */"></i></a>
                    <a href="https://plus.google.com/+Agims"
                       style="display: inline-block;border-right: 1px solid #3b3b3b;text-align: center;width: 50px;"><i
                ...
                <div class="col-lg-18 col-md-18 col-sm-12 col-xs-12 col-xxs-12 text-center" style="text-align: right;">
                    ...
                    <a href="tel:915-209-5381" class="top-phone"
                       onclick="ga('send', 'event', [phonecalls], [mobileCTC], [header9152095381], [none], [fieldsObject]);">
    ...
    <main class="flex-order">
        <section id="home-top" class="hidden-xs">
                    ...
                    <div class="row">
                        ...
                        <form id="searching-form">
                            <div class="input-group input-group-lg">
                                <div type="text" class="form-control" id="everyone-is-searching"
            ...
            <div class="container">
                <div id="iceburg-services">
                    ...
                    <section class="services sthree">
                        ...
                        <div class="col-xs-24">
                            <div class="icon-box sithree"><img
                    ...
                    <section class="services sseven">
                        ...
                        <div class="col-xs-24">
                            <div class="icon-box siseven"><img
                    ...
                    <section class="services seight">
                        ...
                        <div class="col-xs-24">
                            <div class="icon-box sieight"><img
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-4 col-sm-12 home-smarts">
                        ...
                        <p>Not only did AGI earn its Google Partner Status before any other firm in El Paso, we are also
                            the highest volume agency in the region.</p>
                        <p><a href="https://www.google.com/partners/#a_profile;idtf=1345221349;qury=AGI%20Marketing"
                              class="external">Learn more about Google Partners</a></p>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-12" style="text-align: center; padding-top: 20px;">
                        <img class="gybo"
                             src="https://www.agims.com/wp-content/uploads/2018/03/GYBO-logo-blue-withgoogle-stacked.png"
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-4 col-sm-12 home-smarts">
                        ...
                        <p>Partners stay up to date on the latest Google tools and products by passing
                            Google-administered certification exams every 12 months.</p>
                        <p><a href="https://www.google.com/partners/#a_profile;idtf=1345221349;qury=AGI%20Marketing"
                              class="external">Learn more about Google Partners</a></p>
                    </div>
                    <div class="col-md-5 col-sm-12 partner-badge">
                                ...
                                while (have_posts()) {
                                    ...
                                    <li class="text-center">
                                        <div class="case-study">
                                            ...
                                            $image = $image_info[0];
                                            ?>
                                            <img src="<?= $image ?>" alt="<?= get_the_content() ?>"
