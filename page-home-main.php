			...
			<div class="row">
				...
				<div id="iceberg-titles" class="col-xxs-24 text-center">
					...
					<div style="padding: 1em;">
					    <h2 class="iceberg-title-h2" style="text-align: center;">SMALL BUSINESS MARKETING</h2>
					    <h3 class="iceberg-title-h5" style="text-align: center;margin: 0 auto;">WITH BIG BUSINESS RESULTS</h3>
						<p style="text-align: center;font-size: 22px;text-shadow:none;margin-top: 1em;">Check How Your Business is Displayed Online</p>
					  </div>
