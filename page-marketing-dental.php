		...
		<div class="row">
			...
			<div class="col-md-15 col-sm-14">
				...
				<h1 class="special">
					...
					<img src="http://www.agims.com/wp-content/uploads/2016/11/dentalicon.png" alt="Dental Icon"> Boost Your Dental Practice Website Presence
			...
			<div class="col-md-9 col-sm-10">
				...
				<aside class="dark">
					...
					<!-- CF7 Here -->
						...
						<?=do_shortcode('[contact-form-7 id="1921" title="LP Dental"]')?>
		...
		<div class="row">
			...
			<div class="col-xs-24">
				...
				<h2 class="special">
					...
					Our digital marketing specialists will work hard to come up with a strategy to help you increase your ROI &amp; Dental online presence.
