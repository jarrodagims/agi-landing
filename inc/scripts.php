...
#
# Scripts that should run in both the front- and back-end
...
# sherpa_frontend_scripts()
#
# Scripts that should run in the front-end
...
# sherpa_backend_scripts()
#
# Scripts that should run in the front- and back-end
