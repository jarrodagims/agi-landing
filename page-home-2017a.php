	...
	<div class="container">
		...
		<div class="row">
			...
			<div id="toplogo" class="col-lg-5 col-md-7 col-sm-12 col-xs-12 col-xss-12"> 
				...
				<a href="/"> <img src="https://www.agims.com/wp-content/themes/agi2016/img/agi-marketing-logo.png" alt="AGI Marketing"> </a>
			...
			<div id="topnav" class="col-lg-19 col-md-17 col-sm-24">
	            ...
	            <a href="tel:915-209-5381" class="m-phone" onclick="ga('send', 'event', [phonecalls], [mobileCTC], [header9152095381], [none], [fieldsObject]);"><i class="fa fa-mobile" aria-hidden="true"></i></a>
      ...
      <div class="container">
      	...
      	<div class="row">
			...
			<div class="col-lg-18 col-md-18 col-sm-12 col-xs-12 col-xxs-12 text-center" style="text-align: right;">
				...
				<a href="tel:915-209-5381" class="top-phone" onclick="ga('send', 'event', [phonecalls], [mobileCTC], [header9152095381], [none], [fieldsObject]);">
			...
			<div class="row">
				...
				<div id="iceberg-titles" class="col-xxs-24 text-center">					
					...
					<div style="padding: 1em;">
						...
						<p style="text-align: left;font-size: 22px;text-shadow:none;">Increasing the visibility of a business online through search engine optimization, online reputation management, digital, video & social media advertising.</p>
					    ...
					    <form id="searching-form">
							...
							<div class="input-group input-group-lg">
								...
								<div type="text" class="form-control" id="everyone-is-searching" aria-describedby="basic-addon2"></div>
...
</section><section id="question">

	<div class="container">

		<div class="col-xs-24">

			<h5><span>How's your <strong>Digital Presence?</strong> Which one sounds like you?</span></h5>

		</div>



		<div class="col-xs-24 col-md-12  btn-lt">

			<a href="#noweb-popup" class="servicesbtn open-nine"><div class="cbox"><i class="fa fa-check" aria-hidden="true"></i></div><span>I don't even have a website!</span></a>

		</div>

		<div id="noweb-popup" class="white-popup mfp-hide">

			<h2><span>Let's Get Your Business Online</span></h2> 

			<p>Let our Design and SEO Experts get your business online, looking good, and performing great!</p>

			<?php echo do_shortcode( '[contact-form-7 id="3386" title="AGI Home No Website Question"]' ); ?>

		 </div> 

		<div class="col-xs-24 col-md-12 btn-rt">

			<a href="#norank-popup" class="servicesbtn open-ten"><div class="cbox"><i class="fa fa-check" aria-hidden="true"></i></div> <span>I have a website, but it doesn't bring in much business.</span></a>

		</div>

		<div id="norank-popup" class="white-popup mfp-hide">

			<h2><span>Rank Up Today</span></h2> 

			<p>Let our SEO, Digital, and Social Media Experts take a look at your site to see what it would take to get it ranking, seen and advertised online.</p>

			<?php echo do_shortcode( '[contact-form-7 id="3387" title="AGI Home No Rank Question"]' ); ?>
        ...
        <div id="iceburg-services">
			...
			<section class="services sone">   	
				...
				<div class="col-xs-24">
					...
					<div class="icon-box sione"><img src="https://www.agims.com/wp-content/uploads/2017/08/search-engine-optimization.png" style=""></div>
			...
			<section class="services stwo">   	
					...
					<div class="col-xs-24">
						...
						<div class="icon-box sitwo"><img src="https://www.agims.com/wp-content/uploads/2017/08/online-reputation-management.png" style=""></div>
			...
			<section class="services sthree">   
					...
					<div class="col-xs-24">
						...
						<div class="icon-box sithree"><img src="https://www.agims.com/wp-content/uploads/2017/08/web-design.png" style=""></div>
			...
			<section class="services sfour">   	
					...
					<div class="col-xs-24">
						...
						<div class="icon-box sifour"><img src="https://www.agims.com/wp-content/uploads/2017/08/social-media.png" style=""></div>
			...
			<section class="services ssix">   
					...
					<div class="col-xs-24">
						...
						<div class="icon-box sisix"><img src="https://www.agims.com/wp-content/uploads/2017/08/pay-per-click.png" style=""></div>
			...
			<section class="services sseven">   	
					...
					<div class="col-xs-24">
						...
						<div class="icon-box siseven"><img src="https://www.agims.com/wp-content/uploads/2017/08/display-ads.png" style=""></div>
			...
			<section class="services seight">   	
					...
					<div class="col-xs-24">
						...
						<div class="icon-box sieight"><img src="https://www.agims.com/wp-content/uploads/2017/08/remarketing.png" style=""></div>
...
<section class="services sfive">   
					...
					<div class="col-xs-24">
						...
						<div class="icon-box sifive"><img src="https://www.agims.com/wp-content/uploads/2017/08/youtube-marketing.png" style=""></div>
    ...
    <div class="container">
    	...
    	<div class="row">
    		...
    		<h4>Thanks to AGI, our internet leads and new patients that found us online is more than double the industry average.</h4>
...
<section id="home-cta" class="only-mobile">
...
<section id="our-services" style="padding-top:0;">
...
</section><section id="home-street-smarts">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-5 col-sm-12 partner-badge">
			...
			<div class="col-md-4 col-sm-12" style="text-align: center; padding-top: 20px;">

				<img class="gybo" src="https://www.agims.com/wp-content/uploads/2018/03/GYBO-logo-blue-withgoogle-stacked.png" width="100px" height="121px">
			...
			<div class="col-sm-11 white-transparent-bg">
				...
				<ul class="list-unstyled">
					...
					<?php
						...
						$wedo = array(							"Search Engine Optimization" => "#",
			...
			<div class="col-xs-24">
				...
				<ul class="testimonials-slider">
					...
					<?php
						...
						query_posts('post_type=testimonial&posts_per_page=4');						if(have_posts()) {
